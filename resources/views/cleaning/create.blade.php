                        ...
                        <div id="form-container" class="space-y-6 opacity-20 blur-sm pointer-events-none transition-all duration-700">
                            ...
                            @if($type === 'rooms')
                                ...
                                <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-inner">
                                    <div class="flex flex-col md:flex-row justify-between border-b border-gray-300 pb-4 mb-6 items-start">
                                        <div class="flex flex-col gap-4 mb-4 md:mb-0">
                                            <div class="flex items-center gap-4">
                                                <div class="w-16 h-16 bg-white p-3 rounded-xl shadow-sm border border-gray-100 flex items-center justify-center shrink-0">
                                            ...
                                            <div class="mt-2">
                                                <a href="http://srvwdoc01:8080/ennov/prod" target="_blank" class="group relative inline-flex items-center gap-2 px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition-all duration-300 shadow-[0_4px_14px_0_rgba(79,70,229,0.39)] hover:shadow-[0_6px_20px_rgba(79,70,229,0.23)] hover:-translate-y-0.5">
                                                    ...
                                                    <span class="tracking-wide">Voir Protocole</span>
                                                </a>
                                            </div>
                                        </div>
